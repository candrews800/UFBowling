...
<?php page_count("roster"); ?>
<?php include_once('includes/header.php'); ?>
<div id="content_area" class="grid_8">
<ul id="sub-menu">
	<li><a href="roster.php" class="selected">Men</a></li>
...
<?php
		...
		while($mens = mysql_fetch_array($result)){
			...
			echo "<h2 class=\"name\">" . $mens['first_name'] . " " .  $mens['middle_name'] . " " . $mens['last_name'] . " <span class=\"class-status\">{$mens['class_status']}</span></h2>";
